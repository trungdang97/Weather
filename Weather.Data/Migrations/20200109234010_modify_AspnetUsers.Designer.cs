...
namespace Weather.Data.Migrations
{
    ...
    [Migration("20200109234010_modify_AspnetUsers")]
    partial class modify_AspnetUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Weather.Data.V1.CMS_Comment", b =>
                {
                    ...
                    b.Property<Guid?>("CMS_NewsId");

                    b.Property<Guid?>("CMS_PostId");
                    ...
                    b.HasIndex("CMS_NewsId");

                    b.HasIndex("CMS_PostId");
            ...
            modelBuilder.Entity("Weather.Data.V1.Right", b =>
                {
                    ...
                    b.HasIndex("ParentRightId");

                    b.ToTable("Rights");
                });

            modelBuilder.Entity("Weather.Data.V1.RightRole", b =>
                {
                    b.Property<Guid>("RightRoleId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Weather.Data.V1.CMS_Comment", b =>
                {
                    b.HasOne("Weather.Data.V1.CMS_News")
                        .WithMany("Comments")
                        .HasForeignKey("CMS_NewsId");

                    b.HasOne("Weather.Data.V1.CMS_Post")
                        .WithMany("Comments")
                        .HasForeignKey("CMS_PostId");
            ...
            modelBuilder.Entity("Weather.Data.V1.Right", b =>
                {
                    b.HasOne("Weather.Data.V1.Right", "ParentRight")
                        .WithMany("InverseParentRight")
                        .HasForeignKey("ParentRightId");
                });

            modelBuilder.Entity("Weather.Data.V1.RightRole", b =>
                {
                    b.HasOne("Weather.Data.V1.Right", "Right")
                        .WithMany("RightRole")
