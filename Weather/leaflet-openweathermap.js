...
/// <reference path="node_modules/extend/index.js" />
https://stackoverflow.com/questions/6750594/how-do-i-open-a-file-stream-in-javascript
L.OWM = L.TileLayer.extend({
    options: {
        ...
        attribution: 'Weather from <a href="https://osb.com.vn/" alt="World Map and worldwide Weather Forecast online">WeatherMap</a>'
...
L.OWM.Current = L.Layer.extend({
    ...
    //},
    getAttribution: function () {
        return 'Weather from <a href="https://osb.com/" '
            + 'alt="World Map and worldwide Weather Forecast online">WeatherMap</a>';
    },
    ...
    _loadDB: function () {
        ...
        //var connectionstring = "Data Source=.\\SQLEXPRESS;Initial Catalog=PP_VN_00001;Persist Security Info=True;User ID=dnn;Password=123;Provider=SQLOLEDB";
        //connection.Open(connectionstring);
        //var rs = new ActiveXObject("ADODB.Recordset");
        //rs.Open("select * from MRFDLY_Tbl_Quy_I", connection);
        //rs.MoveFirst();
    ...
    displayTextFile: function(filename) {
        var sfile = "";
        ...
        var linearr = fs.readFileSync('text.txt', 'utf8').split('\r\n')
    },
...
L.OWM.Utils = {
    ...
    i18n: {
        ...
        vn: {
            owmlinktitle: 'Chi tiết'
			, temperature: 'Nhiệt độ'
			, temp_minmax: 'Nhiệt độ. min/max'
			, wind: 'Gió'
			, gust: 'Lốc'
			, windforce: 'Sức gió'
			, direction: 'Hướng'
            ...
            // weather conditions, see https://openweathermap.org/weather-conditions
			, id200: 'Sấm sét với mưa nhẹ'
			, id201: 'Sấm sét với mưa'
			, id202: 'Sấm sét với mưa lớn'
			, id210: 'Bão nhẹ'
			, id211: 'Bão'
			, id212: 'Bão lớn'
			, id221: 'Cấp bão'
			, id230: 'Sấm sét với mưa phùn nhẹ'
			, id231: 'Sấm sét với mưa phùn'
			, id232: 'Sấm sét với mưa phùn dày'

			, id300: 'Mưa phùn cường độ nhẹ'
			, id301: 'Mưa phùn'
			, id302: 'Mưa phùn cường độ lớn'
			, id310: 'Mưa cường độ nhẹ'
			, id311: 'Mưa'
			, id312: 'Mưa lớn dữ dội'
			, id321: 'Mưa rào'

			, id500: 'Mưa nhẹ'
			, id501: 'Mưa vừa'
			, id502: 'Mưa cường độ lớn'
			, id503: 'Mưa rất lớn'
			, id504: 'Mưa cực điểm'
			, id511: 'Mưa lạnh'
			, id520: 'Mưa rào cường độ nhẹ'
			, id521: 'Mưa rào'
			, id522: 'Mưa rào cường độ lớn'
